...
let lowPopulation = zooAnimals.filter(list => list.population < 5)
// console.log(lowPopulation)

lowPopAnimals = [];
lowPopulation.forEach(list => lowPopAnimals.push(list.animal_name))
...
const populationTotal = zooAnimals.reduce((total, list) => total + list.population, 0)
